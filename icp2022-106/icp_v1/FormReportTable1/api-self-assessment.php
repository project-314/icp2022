...
if ($request_data->action == "insert") {
  ...
  $query = "SELECT sef.self_assessment_id, sef.self_assessment_date,
                 ...
                 INNER JOIN reference      AS ref ON sef.self_assessment_id = ref.self_assessment_id
  ...
  echo json_encode($data, JSON_UNESCAPED_UNICODE);
    ...
    $query = "SELECT  sef.self_assessment_id,sef.self_assessment_date,
                ...
                FROM self_assessment as sef
                INNER JOIN qa_plan_career AS qap ON sef.qa_plan_career_id = qap.qa_plan_career_id
