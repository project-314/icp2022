...
if ($request_data->action == "insert") {
    ...
    $member_id = (int)$request_data->member_id;
    $query = "SELECT pla.plan_career_id, pla.member_id, pla.career_id, pla.start_date,
                     car.career_name,
                     cag.ca_group_name
              FROM plan_career        AS pla
              ...
              ORDER BY pla.plan_career_id ASC
             ;";
    $statement = $connect->prepare($query);
    $statement->execute();
    ...
    $query = "SELECT pla.plan_career_id,pla.member_id,pla.start_date,
