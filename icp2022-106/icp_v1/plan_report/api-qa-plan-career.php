...
if ($request_data->action == "insert") {
    ...
    $query = "SELECT qpc.qa_plan_career_id,
                     ...
                     qpc.qualification_id, qua.qualification_name,
                     qpc.level_id,lev.level_name,lev.level_description,
                     qpc.target_id,tar.target_name,
    ...
    $query = "SELECT qpc.qa_plan_career_id,
                     ...
                     lev.level_id, lev.level_description
                ...
                GROUP BY qpc.qa_plan_career_id
    ;";
    $statement = $connect->prepare($query);
    $statement->execute();
    while ($row = $statement->fetch(PDO::FETCH_ASSOC)) {
...
else if ($request_data->action == "qa_plan_career_plan") {
    $member_id = (int) $request_data->member_id;
    $query = "SELECT qpc.qa_plan_career_id,
                     mem.member_id, mem.full_name,
                     car.career_id, car.career_name,
                ...
                INNER JOIN plan_career   AS plc ON qpc.plan_career_id = plc.plan_career_id
...
else if ($request_data->action == "qa_plan_career_by_plan_career_id") {
    $plan_career_id = (int) $request_data->plan_career_id;
    $query = "SELECT qpc.qa_plan_career_id,
                    mem.member_id, mem.full_name,
                    car.career_id, car.career_name,
...
else if ($request_data->action == "qa_plan_career_by_qualification_id") {
    $plan_career_id = (int) $request_data->plan_career_id;
    $qualification_id = (int) $request_data->qualification_id;
    $query = "SELECT qpc.qa_plan_career_id,
                    mem.member_id, mem.full_name,
